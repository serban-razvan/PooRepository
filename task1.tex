...
\begin{tikzpicture}
	...
	child[concept color = blue!30!teal] {
		...
		node[concept] {Clase abstracte}[clockwise from=90]
			child[concept color = blue!30!teal] {
			node[concept] {Ce pot conține}[clockwise from=140] {child{node[concept]{Metode abstracte}}}
			node[concept] {Ce pot conține}[clockwise from=110] {child{node[concept]{Membri}}}
			node[concept] {Ce pot conține}[clockwise from=80] {child{node[concept]{Specificatori de acces}}}
			node[concept] {Ce pot conține}[clockwise from=50] {child{node[concept]{Constructori}}}
}	
	...
	child[concept color = green!50!teal] {
		node[concept] {Interfețe} [clockwise from=90]
			child[concept color = green!50!teal]{
				node[concept]{Ce pot conține}[clockwise from = 30]{child{node[concept]{Semnături de metode}}}
				node[concept]{Ce pot conține}[clockwise from = 60]{child{node[concept]{Metode statice}}}
				node[concept]{Ce pot conține}[clockwise from = 90]{child{node[concept]{Constante}}}
				node[concept]{Ce pot conține}[clockwise from = 120]{child{node[concept, text = red]{\textbf{TODO:}}}}
}
