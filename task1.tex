...
\begin{tikzpicture}
	...
	child[concept color = blue!30!teal] {
		...
		node[concept] {Clase abstracte}[clockwise from=90]
			child[concept color = blue!30!teal] {
			node[concept] {Ce poate conține}[clockwise from=140] {child{node[concept]{Metode abstracte}}}
			node[concept] {Ce poate conține}[clockwise from=110] {child{node[concept]{Membri}}}
			node[concept] {Ce poate conține}[clockwise from=80] {child{node[concept]{Specificatori de acces}}}
			node[concept] {Ce poate conține}[clockwise from=50] {child{node[concept]{Constructori}}}
}	
