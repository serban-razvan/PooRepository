...
\begin{tikzpicture}
	...
	child[concept color = blue!30!teal] {
		...
		node[concept] {Clase abstracte} [clockwise from=45]
			child[concept color = blue!30!teal] {
			node[concept] {TODO:}[clockwise from=90] {child{node[concept]{TODO:}}}
			node[concept] {TODO:}[clockwise from=60] {child{node[concept]{TODO:}}}
			node[concept] {TODO:}[clockwise from=30] {child{node[concept]{TODO:}}}
			node[concept] {TODO:}[clockwise from=0] {child{node[concept]{TODO:}}}
}
