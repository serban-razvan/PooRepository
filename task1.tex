...
\begin{tikzpicture}
	...
	child[concept color = blue!30!teal] {
		node[concept] {Clase abstracte}[clockwise from=45]
			...
			node[concept] {Keywords}[clockwise from=10] {child{node[concept]{TODO:}}}
}		
		...
		node[concept] {Clase abstracte}[clockwise from=0]
			...
			node[concept] {Generalități}[clockwise from = -31] {child{node[concept]{TODO:}}}
}
		node[concept] {Clase abstracte}[clockwise from=-45]
			child[concept color = white!35!blue] {
			node[concept]{TODO:}[clockwise from = -10] {child{node[concept]{TODO:}}}
			node[concept]{TODO:}[clockwise from = -40] {child{node[concept]{TODO:}}}
			node[concept]{TODO:}[clockwise from = -70] {child{node[concept]{TODO:}}}
}
		node[concept] {Clase abstracte} [clockwise from=-90]
